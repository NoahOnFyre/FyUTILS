...
for i in range(99999):
    ...
    time.sleep(0.05)
    print(Fore.CYAN + "[COMMANDS] " + Fore.WHITE + "portscan: Finds all open ports of an IP adress.")
    time.sleep(0.05)
    print(Fore.CYAN + "[COMMANDS] " + Fore.WHITE + "ssh: Opens a SSH connection between your PC and a server/pc.")
    time.sleep(0.05)
    print(Fore.CYAN + "[COMMANDS] " + Fore.WHITE + "full: Toggles fullscreen.")
    time.sleep(0.05)
    ...
    print("")
    cmd = input(
        Fore.WHITE + user + Fore.LIGHTBLACK_EX + "/" + Fore.WHITE + "FyUTILS" + Fore.LIGHTBLACK_EX + " >> " + Fore.CYAN)
