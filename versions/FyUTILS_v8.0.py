...
def init():
    try:
        ...
        licensekey = input("Enter your license key: ")
        ...
        time.sleep(3)
    updateAvailable = requests.get("https://pastebin.com/raw/ibth5vG2").content.decode("UTF8")
    if updateAvailable == "true":
        print(Fore.GREEN + "Update available!")
        time.sleep(2)
        os.system("start https://github.com/NoahOnFyre/FyUTILS/releases")
        exit()
...
for i in range(99999):
    ...
    print("")
    cmd = input(
        textcol(0) + user + color(0) + "@" + textcol(0) + device + accent(0) + "/" + color(0) + "FyUTILS" + accent(
            0) + " >> " + color(0))
